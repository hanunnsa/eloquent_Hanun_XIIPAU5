...
class database 
{
    ...
    {
        mysqli_query($this->koneksi,"INSERT INTO barang SET nama_barang='$nama_barang', stok='$stok', harga_beli='$harga_beli', harga_jual='$harga_jual'");
    }
